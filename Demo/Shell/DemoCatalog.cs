...
public static class DemoCatalog
{
    ...
    [
        ...
        new DemoEntry(
            ...
            ["F1  menu      F2  profiler (off / fps / cpu / gpu)      N  next page", "Right mouse + WASD  fly", "Left mouse  dig      F  fill", "V  traced grid on/off", "B  drawn surface: iso / cubes", "C  collider form: box / sphere / MC / SN", "F11  collider wireframe"],
